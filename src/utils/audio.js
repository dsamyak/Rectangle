// ──────────────────────────────────────────────────
// Enhanced Audio Narration Engine — Rectangle Geometry
// ──────────────────────────────────────────────────
...
export function seg(text, style = 'statement', pauseMs = 400) {
  return { text, style, pause: pauseMs };
}

export const say = (text, pauseMs = 0) => seg(text, 'statement', pauseMs);
export const ask = (text, pauseMs = 0) => seg(text, 'question', pauseMs);
export const cheer = (text, pauseMs = 0) => seg(text, 'encouragement', pauseMs);
export const emphasize = (text, pauseMs = 0) => seg(text, 'emphasis', pauseMs);
export const think = (text, pauseMs = 0) => seg(text, 'thinking', pauseMs);
export const celebrate = (text, pauseMs = 0) => seg(text, 'celebration', pauseMs);
export const instruct = (text, pauseMs = 0) => seg(text, 'instruction', pauseMs);
